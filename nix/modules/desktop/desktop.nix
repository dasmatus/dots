...
# settings.desktop == "hyprland" (nix/system/defaults.nix) — any other value (e.g.
# "none") skips it. The if-then-else mirrors the nvidia branch style in
# nix/system/hosts.nix. NOTE: the Home Manager side (nix/home/desktop/hyprland.nix + friends)
      ...
      lib.mkMerge [
        {
          ...
          # nix/home/desktop/hyprland.nix, where HM eval rejected it.
