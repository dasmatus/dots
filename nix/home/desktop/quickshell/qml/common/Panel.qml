...
// focus handling, the click-outside-to-dismiss `PanelWindow` around it,
// stays in each caller; this is only the chrome that was byte-for-byte the
// same in both: the Theme.bg + Theme.alphaPanel fill, and the MouseArea that
