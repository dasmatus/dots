...
# plus a Theme.qml generated from nix/data/palette.json.
#
# Generating rather than hand-writing the palette keeps nix/data/palette.json the
...
let
  ...
  palette = builtins.fromJSON (builtins.readFile ../../../data/palette.json);
  ...
  themeQml = ''
    ...
    // Generated by nix/home/desktop/quickshell/tree.nix from nix/data/palette.json.
