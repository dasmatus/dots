...
# nix/home/claude.nix builds its searxng bridge against.
#
...
# keyring (gnome-keyring, enabled in nix/modules/desktop.nix) through
# libsecret's secret-tool at spawn time. That is the same Secret Service
# nix/home/git.nix already uses via `credential.helper = "libsecret"`.
