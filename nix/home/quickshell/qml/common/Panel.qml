// The rounded, bordered surface both the launcher and the settings form draw
// their content on. What actually differs between the two — placement, size,
...
// both: the Theme.bg + Theme.alphaPanel fill, the accent border, and the
// MouseArea that swallows a click before it reaches the dismiss handler
// behind the panel.
//
