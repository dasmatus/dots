...
function planFor(cfg, flakeSrc = "/etc/dots", mnt = "/mnt") {
    ...
    return [
        ...
        },
        {
            ...
            action: command("disko", ["--mode", "destroy,format,mount", "--yes-wipe-all-disks", "--arg", "disks", disksArg, "--argstr", "swapSize", swap, `${flakeSrc}/nix/disko.nix`], "Stream")
        },
        {
            ...
            // with absolute dangling symlinks (nix/settings.nix ->
        ...
        },
        {
            ...
            action: command("sh", ["-c", `mkdir -p ${mnt}/persist/var/lib/dots/nix && cp ${STAGED_FLAKE}/nix/facter.json ${mnt}/persist/var/lib/dots/ && cp ${STAGED_FLAKE}/nix/settings.nix ${mnt}/persist/var/lib/dots/`], "Stream")
        },
        {
